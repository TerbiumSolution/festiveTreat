...
export default function MobileAccordionTabs({ stateInterlinks, cityInterlinks }: { stateInterlinks: InterlinkItemType[], cityInterlinks: InterlinkItemType[] }) {
   ...
   return (
      <section>
         <Accordion type="single" collapsible className={`block md:hidden md:pt-15 md:pb-15 md:px-16 px-4 py-10 w-full`}>
