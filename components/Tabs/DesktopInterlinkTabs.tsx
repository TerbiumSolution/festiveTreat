...
export default function DesktopInterlinkTabs({ layout, stateInterlinks, cityInterlinks }: { layout: string, stateInterlinks: InterlinkItemType[], cityInterlinks: InterlinkItemType[] }) {
