...
export default function Header({}) {
  ...
  // const [upperHeaderHeight, setUpperHeaderHeight] = useState(0);

  // useEffect(() => {
  //   // Get the height of the upper header
  //   const upperHeaderElement = document.querySelector('[data-upper-header]');
  //   if (upperHeaderElement) {
  //     setUpperHeaderHeight(upperHeaderElement.clientHeight);
  //   }

  //   const handleScroll = () => {
  //     const scrollPosition = window.scrollY;
  //     // Hide upper header and make navigation sticky when scrolled past upper header
  //     setIsScrolled(scrollPosition > upperHeaderHeight);
  //   };
  ...
  return (
    <header className="w-full lg:mb-[67px] mb-[62px]">
        {/* Upper Header - Blue section */}
        <div className={`bg-[#004C8F] hidden lg:block fixed top-0 left-0 right-0 z-50`}>
          <UpparHeader/>
        </div>
