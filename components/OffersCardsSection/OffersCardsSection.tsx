...
export default function OffersCardsSection({ context, deals, nonce }: { context: ComponentPropsType, deals: DealType[], nonce: string }) {
   ...
   const offerStructureData = useMemo(() => extractOffers(offerDeals, layout), [offerDeals]);
