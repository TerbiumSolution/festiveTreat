...
export function BlockRenderer(context: BlockRendererContext, data: BlockRendererData) {
  const { layout, nonce, title, categories, states, category, subcategory, merchant, state, city } = context;
  const { block, deals } = data;

  const contextProps = { layout, title, categories, states, category, subcategory, merchant, state, city };
